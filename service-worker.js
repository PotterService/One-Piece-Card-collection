const SHELL='bow-one-piece-shell-v1',IMAGES='bow-one-piece-images-v1',FILES=['./','./index.html','./assets/css/styles.css','./assets/js/db.js','./assets/js/app.js','./manifest.webmanifest'];
